-- ============================================================================
-- LEGACY REFERENCE ONLY - NOT USED BY THE APPLICATION, NOT RUNNABLE AS-IS.
--
-- This is the original DBMS coursework schema/design (kept for academic
-- reference: full ER model including employees, fare history, and Oracle
-- PL/SQL stored procedures/triggers/audit tables). It predates the running
-- app and contains Oracle-only syntax (CURSOR/dbms_output/%ROWTYPE, a
-- malformed "TICKET_DECIMAL(10,2)" column definition, DD-MON-YY date
-- literals) that MySQL cannot execute.
--
-- To set up the database the app actually uses, run sql/schema.sql instead
...
(TICKET_DECIMAL(10,2) INT NOT NULL,
SOURCE VARCHAR(3),
DESTINATION VARCHAR(3),
...
INSERT INTO TICKET1(TICKET_DECIMAL(10,2), SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO)
...
select al.AL_NAME,fl.FLIGHT_CODE,p2.FNAME,p2.LNAME,p2.PASSPORTNO,t.CLASS,t.DATE_OF_TRAVEL,t.DESTINATION,t.SOURCE,t.SEATNO,t.TICKET_DECIMAL(10,2) from Airline al,Flight fl,PASSENGER1 p1,PASSENGER2 p2 ,PASSENGER3 p3,TICKET1 t
...
Open ECOPASSDETAILS ;
   ...
   dbms_output.put_line (PASSDETAILS.AL_NAME || '  ' || PASSDETAILS.FLIGHT_CODE || '  ' || PASSDETAILS.FNAME || '  ' || PASSDETAILS.LNAME|| '  ' ||PASSDETAILS.PASSPORTNO || '  ' || PASSDETAILS.CLASS || '  ' || PASSDETAILS.SOURCE || '  ' || PASSDETAILS.SEATNO || '  ' || PASSDETAILS.TICKET_DECIMAL(10,2));
